          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="bg-[#242424] rounded-lg p-4 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 flex-1">
                ...
                />
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-semibold">Фрибет до <span className="text-orange-500">15 000</span>₽</div>
                  <div className="text-xs text-gray-400"></div>
                  <div className="text-xs text-gray-500 mt-1"></div>
                </div>
              </div>
            ...
            <div className="bg-[#242424] rounded-lg p-4 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 flex-1">
                ...
                />
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-semibold">Фрибет до <span className="text-yellow-400">10 000</span>₽ от</div>
                  <div className="text-xs text-gray-400"></div>
                  <div className="text-xs text-gray-500 mt-1"></div>
                </div>
              </div>
